...
class MoleculeDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        if self.dataset == 'zinc_standard_agent':
            index = torch.load('/home/dyl/Graph-code/pretrain-gnns/chem/dataset/zinc_scaffold_v3_9000')
...
if __name__ == "__main__":
    ...
    # create_all_datasets()
    dataset = MoleculeDataset(root="dataset/zinc_scaffold/zinc_scaffold_v3", dataset='zinc_standard_agent')
